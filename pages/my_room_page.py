...
class LeftBlock(Component):
    ...
    def get_name_by_my_world(self):
        self.wait_element_visible(self.MY_WORLD_NAME)
        return self.driver.find_element_by_xpath(self.MY_WORLD_NAME).text

    def go_to_photos(self):
        self.wait_element_click(self.MY_PHOTOS_BUTTON)
    ...
    def is_photos(self):
        self.wait_element_visible(self.MY_WORLD_CATEGORY_TITLE)
        return self.driver.find_element_by_xpath(self.MY_WORLD_CATEGORY_TITLE).text

    def go_to_videos(self):
        self.wait_element_click(self.MY_VIDEOS_BUTTON)
    ...
    def is_videos(self):
        try:
            self.wait_element_visible(self.MY_VIDEOS_TITLE)
        except TimeoutException:
            return False
        return True

    def press_settings(self):
        self.wait_element_click(self.SETINGS_BUTTON)
        self.driver.find_element_by_xpath(self.SETINGS_BUTTON).click()
        return self.driver.current_url

    def press_activity(self):
        self.wait_element_click(self.ACTIVITY_BUTTON)
...
class CenterForm(Component):
    ...
    def unsubscribe_question(self, title):
        self.wait_element_visible(self.CHECK_QUESTION % title)
    ...
    def unsubscribe_user(self, user_id):
        self.wait_element_visible(self.CHECK_USER % user_id)
